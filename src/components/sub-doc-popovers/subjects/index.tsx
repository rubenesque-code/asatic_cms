...
const SubjectTranslations = () => {
  const { docLanguagesIds: docLanguagesById } = useComponentContext();
...
const SubjectInput = ({
  ...
  const { docActiveLanguageId, addSubjectToDoc: onAddSubjectToDoc } =
    useComponentContext();
...
const SubjectMatch = ({ subject }: { subject: SubjectType }) => {
  const {
    docSubjectsIds: docSubjectsById,
    addSubjectToDoc: onAddSubjectToDoc,
  } = useComponentContext();
