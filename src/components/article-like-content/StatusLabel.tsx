...
import { ArticleLikeContentStatus } from "^types/article-like-primary-content";

const ArticleLikeContentStatusLabel = ({
  publishDate,
  includeNewType,
  showPublished = true,
  status,
  ...
  status: ArticleLikeContentStatus;
}) => {
...
export default ArticleLikeContentStatusLabel;
