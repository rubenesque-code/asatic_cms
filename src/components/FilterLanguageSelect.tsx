...
export default function FilterLanguageSelect() {}
...
FilterLanguageSelect.Provider = function LanguageSelectProvider({
  children,
}: {
...
FilterLanguageSelect.useContext = function useLanguageSelectContext() {
...
FilterLanguageSelect.Select = function Select() {
